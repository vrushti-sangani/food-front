...
const Auth = () => {
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      {/* Right Section */}
      <div className="w-1/2 min-h-screen bg-[#1a1a1a] p-2">
        <div className="flex flex-col items-center gap-2">
          <img src={logo} alt="Restro Logo" className="h-14 w-14 border-2 rounded-full p-1 mt-3" />
          <h1 className="text-lg font-semibold text-[#f5f5f5] tracking-wide">Restro</h1>
        </div>

        <h2 className="text-4xl text-center mt-2 font-semibold text-yellow-400 mb-7">
